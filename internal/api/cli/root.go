...
import (
	...
	_ "github.com/dpopsuev/emcee/internal/infrastructure/jira"
	_ "github.com/dpopsuev/emcee/internal/infrastructure/linear"
	_ "github.com/dpopsuev/emcee/internal/infrastructure/reportportal"

	mcpserver "github.com/dpopsuev/emcee/internal/api/mcp"
...
func newService() (*application.Service, error) {
...
func newServiceFromConfig() (*application.Service, error) {
...
func injectTriage(svc *application.Service) {
	...
	svc.Apply(
		...
		application.WithGraphStore(triage.NewInMemoryGraphStore()),
		application.WithCrawlRateLimit(5), // 5 req/s — be polite
	)
}

...
var _ repository.IssueRepository = (*mockRepo)(nil)
var _ repository.DocumentRepository = (*mockRepo)(nil)
var _ repository.ProjectRepository = (*mockRepo)(nil)
var _ repository.InitiativeRepository = (*mockRepo)(nil)
var _ repository.LabelRepository = (*mockRepo)(nil)
var _ repository.BulkIssueRepository = (*mockRepo)(nil)
...
func newTestService() *application.Service {
	return application.NewService(&mockRepo{
		name: "test",
		issues: []domain.Issue{
...
func TestParseRef(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.ref, func(t *testing.T) {
			backend, key, err := application.ParseRef(tt.ref)
			if tt.wantErr {
				if err == nil {
